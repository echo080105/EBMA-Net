...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------#
    test_interval = 100
    fps_image_path = "img/randomGaussian_0_randomGaussian_slug_6_0.jpg"
    # -------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        img = Image.open('img/randomGaussian_0_randomGaussian_slug_6_0.jpg')
        ...
        for img_name in tqdm(img_names):
            if img_name.lower().endswith(
                ...
                r_image = unet.detect_image(image, name_classes)

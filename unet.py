...
class Unet(object):
    ...
    #   检测图片
    # ---------------------------------------------------#
    def detect_image(self, image, name_classes, count=True):
        # ---------------------------------------------------------#
        ...
        if count:
            ...
            classes_nums = np.delete(classes_nums, 0)
            print(classes_nums)
            print(name_classes[np.argmax(classes_nums) + 1])
